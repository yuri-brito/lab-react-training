...
import RBGColorPicker from './components/RGBColorPicker/RGBColorPicker';
...
function App() {
  return (
    <div className="App">
      ...
      <Rating>4</Rating>
      <Rating>5</Rating>
      <DriverCard name="Travis Kalanick" rating={4.2} img="https://si.wsj.net/public/resources/images/BN-TY647_37gql_OR_20170621052140.jpg?" car={{
